	...
	<div id="wrapper">
		...
		<ul class="navbar-nav background-navbar sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<li class="nav-item <?php if (isset($menu1A)) echo $menu1A ?>">
				<a class="nav-link" href="my-order.php?page=1A">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle " href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<span class="mr-2 d-none d-lg-inline text-primary small "><i class="fas fa-user fa-sm fa-fw mr-2 "></i><?= $_SESSION["name"] ?></span>
							</a>
						</li>
